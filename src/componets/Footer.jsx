...
function Footer() {
  return (
    <div className='w-full h-screen bg-[#f1f1f1]  p-20 text-black flex '>
        <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
        <h1 className='text-[10vw] uppercase leading-none  font-[primary] font-semibold'> Eye-</h1>
        <h1 className='text-[10vw] font-[primary] uppercase leading-none font-semibold '>Opening</h1>
        </div>
        ...
        <div className="w-1/2">
        <h1 className='text-[10vw] uppercase leading-none  font-[primary] font-semibold'> Presentation
         
        </h1>
        <h1 className='uppercase  text-xl font-[secondary]'>s:</h1>
        <div className='dets flex flex-col font-[secondary] py-10 underline decoration-solid  '>
            <a href="#">Facebook</a>
            <a href="#">Twitter</a>
            <a href="#">Instagram</a>
            <a href="#">Linkinden</a>
            <h1 className='py-10 underline-none'>L:</h1>
            <a href="#">202-1965 W 4th Ave</a>
            <a  href="#">Vancouver, Canada</a>
            <a className='pt-5' href="#">30 Chukarina St</a>
            <a href="#">Lviv, Ukraine</a>
            <h1 className='pt-5 pb-5'>E:</h1>
